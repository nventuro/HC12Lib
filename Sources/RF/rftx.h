...
// id indicates the id of the receiver (from 0 to 7). The content of the message (of length bits, up to 127, from MSB TO LSB) must be stored beforehand in data, and 
