...
// Timing in us
// f = 3khz
#define RFTX_1_HIGH_TIME_US (325*2)
#define RFTX_1_LOW_TIME_US (500*2)
#define RFTX_0_HIGH_TIME_US (500*2)
#define RFTX_0_LOW_TIME_US (325*2)

#define RFTX_DEAD_TIME_US (1000*2)
#define RFTX_START_TX_TIME_US (250*2)
#define RFTX_TICK_TIMEOUT_US (7500)
#define RFTX_TICK_DURATION_US (1500)
